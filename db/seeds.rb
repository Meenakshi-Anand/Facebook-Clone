...
FriendRequest.create!(requestor_id:u3.id,approver_id:u1.id,approval_status:"accepted")
FriendRequest.create!(requestor_id:u3.id,approver_id:u2.id,approval_status:"accepted")
...
c1 = Comment.create!(post_id:u1.id,author_id:u1.id,body:"Summer is here")
c2 = Comment.create!(post_id:u2.id,author_id:u4.id,body:"Hello all")
c3 = Comment.create!(post_id:u3.id,author_id:u2.id,body:"When is the party")
c4 = Comment.create!(post_id:u3.id,author_id:u1.id,body:"Feeling happy")
c5 = Comment.create!(post_id:u1.id,author_id:u1.id,body:"Pretty Pretty")
c6 = Comment.create!(post_id:u5.id,author_id:u2.id,body:"sweet !!!")
c7 = Comment.create!(post_id:u2.id,author_id:u1.id,body:"Have a nice day")
c9 = Comment.create!(post_id:u4.id,author_id:u1.id,body:"Happy morning")
c8 = Comment.create!(post_id:u4.id,author_id:u4.id,body:"All the best")
c10 = Comment.create!(post_id:u1.id,author_id:u1.id,body:"hey der")
