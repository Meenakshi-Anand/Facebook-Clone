...
c3 = Post.create!(post_id:u3.id,author_id:u2.id,body:"When is the party")
c4 = Post.create!(post_id:u3.id,author_id:u1.id,body:"Feeling happy")
c5 = Post.create!(post_id:u1.id,author_id:u1.id,body:"Pretty Pretty")
c6 = Post.create!(post_id:u5.id,author_id:u2.id,body:"sweet !!!")
c7 = Post.create!(post_id:u2.id,author_id:u1.id,body:"Have a nice day")
c9 = Post.create!(post_id:u4.id,author_id:u1.id,body:"Happy morning")
c8 = Post.create!(post_id:u4.id,author_id:u4.id,body:"All the best")
c10 = Post.create!(post_id:u1.id,author_id:u1.id,body:"hey der")
